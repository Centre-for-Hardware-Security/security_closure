...
file copy -force ../run/scores.rpt ../security_scripts/low_area_low_exposure/pre_security_scores.rpt
...
file copy -force ../run/scores.rpt ../security_scripts/low_area_low_exposure/post_security_scores.rpt