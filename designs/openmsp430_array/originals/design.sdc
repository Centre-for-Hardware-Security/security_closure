...
# Created by write_sdc on Thu Mar  3 11:39:42 2022

###################################################################
set sdc_version 2.0

set_units -time ns -resistance MOhm -capacitance fF -voltage V -current mA
create_clock [get_ports dco_clk]  -period 8  -waveform {0 4}
create_clock [get_ports lfxt_clk]  -period 8  -waveform {0 4}
...
set_input_delay -clock dco_clk  -max 2  [get_ports {irq[13]}]
set_input_delay -clock dco_clk  -min 0  [get_ports {irq[13]}]
set_input_delay -clock dco_clk  -max 2  [get_ports {irq[12]}]
set_input_delay -clock dco_clk  -min 0  [get_ports {irq[12]}]
set_input_delay -clock dco_clk  -max 2  [get_ports {irq[11]}]
set_input_delay -clock dco_clk  -min 0  [get_ports {irq[11]}]
set_input_delay -clock dco_clk  -max 2  [get_ports {irq[10]}]
set_input_delay -clock dco_clk  -min 0  [get_ports {irq[10]}]
set_input_delay -clock dco_clk  -max 2  [get_ports {irq[9]}]
set_input_delay -clock dco_clk  -min 0  [get_ports {irq[9]}]
set_input_delay -clock dco_clk  -max 2  [get_ports {irq[8]}]
set_input_delay -clock dco_clk  -min 0  [get_ports {irq[8]}]
set_input_delay -clock dco_clk  -max 2  [get_ports {irq[7]}]
set_input_delay -clock dco_clk  -min 0  [get_ports {irq[7]}]
set_input_delay -clock dco_clk  -max 2  [get_ports {irq[6]}]
set_input_delay -clock dco_clk  -min 0  [get_ports {irq[6]}]
set_input_delay -clock dco_clk  -max 2  [get_ports {irq[5]}]
set_input_delay -clock dco_clk  -min 0  [get_ports {irq[5]}]
set_input_delay -clock dco_clk  -max 2  [get_ports {irq[4]}]
set_input_delay -clock dco_clk  -min 0  [get_ports {irq[4]}]
set_input_delay -clock dco_clk  -max 2  [get_ports {irq[3]}]
set_input_delay -clock dco_clk  -min 0  [get_ports {irq[3]}]
set_input_delay -clock dco_clk  -max 2  [get_ports {irq[2]}]
set_input_delay -clock dco_clk  -min 0  [get_ports {irq[2]}]
set_input_delay -clock dco_clk  -max 2  [get_ports {irq[1]}]
set_input_delay -clock dco_clk  -min 0  [get_ports {irq[1]}]
set_input_delay -clock dco_clk  -max 2  [get_ports {irq[0]}]
set_input_delay -clock dco_clk  -min 0  [get_ports {irq[0]}]
set_input_delay -clock dco_clk  -max 1.6  [get_ports {per_dout[15]}]
set_input_delay -clock dco_clk  -min 0  [get_ports {per_dout[15]}]
set_input_delay -clock dco_clk  -max 1.6  [get_ports {per_dout[14]}]
set_input_delay -clock dco_clk  -min 0  [get_ports {per_dout[14]}]
set_input_delay -clock dco_clk  -max 1.6  [get_ports {per_dout[13]}]
set_input_delay -clock dco_clk  -min 0  [get_ports {per_dout[13]}]
set_input_delay -clock dco_clk  -max 1.6  [get_ports {per_dout[12]}]
set_input_delay -clock dco_clk  -min 0  [get_ports {per_dout[12]}]
set_input_delay -clock dco_clk  -max 1.6  [get_ports {per_dout[11]}]
set_input_delay -clock dco_clk  -min 0  [get_ports {per_dout[11]}]
set_input_delay -clock dco_clk  -max 1.6  [get_ports {per_dout[10]}]
set_input_delay -clock dco_clk  -min 0  [get_ports {per_dout[10]}]
set_input_delay -clock dco_clk  -max 1.6  [get_ports {per_dout[9]}]
set_input_delay -clock dco_clk  -min 0  [get_ports {per_dout[9]}]
set_input_delay -clock dco_clk  -max 1.6  [get_ports {per_dout[8]}]
set_input_delay -clock dco_clk  -min 0  [get_ports {per_dout[8]}]
set_input_delay -clock dco_clk  -max 1.6  [get_ports {per_dout[7]}]
set_input_delay -clock dco_clk  -min 0  [get_ports {per_dout[7]}]
set_input_delay -clock dco_clk  -max 1.6  [get_ports {per_dout[6]}]
set_input_delay -clock dco_clk  -min 0  [get_ports {per_dout[6]}]
set_input_delay -clock dco_clk  -max 1.6  [get_ports {per_dout[5]}]
set_input_delay -clock dco_clk  -min 0  [get_ports {per_dout[5]}]
set_input_delay -clock dco_clk  -max 1.6  [get_ports {per_dout[4]}]
set_input_delay -clock dco_clk  -min 0  [get_ports {per_dout[4]}]
set_input_delay -clock dco_clk  -max 1.6  [get_ports {per_dout[3]}]
set_input_delay -clock dco_clk  -min 0  [get_ports {per_dout[3]}]
set_input_delay -clock dco_clk  -max 1.6  [get_ports {per_dout[2]}]
set_input_delay -clock dco_clk  -min 0  [get_ports {per_dout[2]}]
set_input_delay -clock dco_clk  -max 1.6  [get_ports {per_dout[1]}]
set_input_delay -clock dco_clk  -min 0  [get_ports {per_dout[1]}]
set_input_delay -clock dco_clk  -max 1.6  [get_ports {per_dout[0]}]
...
set_output_delay -clock dco_clk  -max 3  [get_ports aclk_en]
set_output_delay -clock dco_clk  -min 0  [get_ports aclk_en]
set_output_delay -clock dco_clk  -max 3  [get_ports dbg_freeze]
...
set_output_delay -clock dco_clk  -max 2  [get_ports {irq_acc[13]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {irq_acc[13]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {irq_acc[12]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {irq_acc[12]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {irq_acc[11]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {irq_acc[11]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {irq_acc[10]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {irq_acc[10]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {irq_acc[9]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {irq_acc[9]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {irq_acc[8]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {irq_acc[8]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {irq_acc[7]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {irq_acc[7]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {irq_acc[6]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {irq_acc[6]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {irq_acc[5]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {irq_acc[5]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {irq_acc[4]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {irq_acc[4]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {irq_acc[3]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {irq_acc[3]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {irq_acc[2]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {irq_acc[2]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {irq_acc[1]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {irq_acc[1]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {irq_acc[0]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {irq_acc[0]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {per_addr[13]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {per_addr[13]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {per_addr[12]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {per_addr[12]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {per_addr[11]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {per_addr[11]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {per_addr[10]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {per_addr[10]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {per_addr[9]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {per_addr[9]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {per_addr[8]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {per_addr[8]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {per_addr[7]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {per_addr[7]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {per_addr[6]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {per_addr[6]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {per_addr[5]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {per_addr[5]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {per_addr[4]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {per_addr[4]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {per_addr[3]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {per_addr[3]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {per_addr[2]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {per_addr[2]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {per_addr[1]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {per_addr[1]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {per_addr[0]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {per_addr[0]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {per_din[15]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {per_din[15]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {per_din[14]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {per_din[14]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {per_din[13]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {per_din[13]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {per_din[12]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {per_din[12]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {per_din[11]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {per_din[11]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {per_din[10]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {per_din[10]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {per_din[9]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {per_din[9]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {per_din[8]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {per_din[8]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {per_din[7]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {per_din[7]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {per_din[6]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {per_din[6]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {per_din[5]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {per_din[5]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {per_din[4]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {per_din[4]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {per_din[3]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {per_din[3]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {per_din[2]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {per_din[2]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {per_din[1]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {per_din[1]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {per_din[0]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {per_din[0]}]
set_output_delay -clock dco_clk  -max 2  [get_ports per_en]
set_output_delay -clock dco_clk  -min 0  [get_ports per_en]
set_output_delay -clock dco_clk  -max 2  [get_ports {per_we[1]}]
set_output_delay -clock dco_clk  -min 0  [get_ports {per_we[1]}]
set_output_delay -clock dco_clk  -max 2  [get_ports {per_we[0]}]
...
set_output_delay -clock dco_clk  -max 3  [get_ports puc_rst]
set_output_delay -clock dco_clk  -min 0  [get_ports puc_rst]
set_output_delay -clock dco_clk  -max 3  [get_ports smclk_en]
