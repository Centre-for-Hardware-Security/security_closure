## library_sets
create_library_set -name generic_library_set -timing { ../../../libraries/NangateOpenCellLibrary_slow_ccs.lib }

## opcond
create_opcond -name generic_opcond -process 1.0 -voltage 0.95 -temperature 125.0
...
create_constraint_mode -name generic_constraints \
    -sdc_files { ../originals/design.sdc }
