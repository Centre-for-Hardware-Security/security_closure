...
file copy -force ../run/scores.rpt ../security_scripts/low_area/pre_security_scores.rpt
...
file copy -force ../run/scores.rpt ../security_scripts/low_area/post_security_scores.rpt