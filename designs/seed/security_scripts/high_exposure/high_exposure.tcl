...
file copy -force ../run/scores.rpt ../security_scripts/high_exposure/pre_security_scores.rpt
...
file copy -force ../run/scores.rpt ../security_scripts/high_exposure/post_security_scores.rpt