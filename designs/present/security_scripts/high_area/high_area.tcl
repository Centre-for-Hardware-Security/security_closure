...
file copy -force ../run/scores.rpt ../security_scripts/high_area/pre_security_scores.rpt
...
file copy -force ../run/scores.rpt ../security_scripts/high_area/post_security_scores.rpt